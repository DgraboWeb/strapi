...
export interface ApiActividadHiloActividadHilo
  extends Struct.CollectionTypeSchema {
...
export interface ApiHabilitadoHabilitado extends Struct.SingleTypeSchema {
  collectionName: 'habilitados';
  info: {
    displayName: 'habilitado';
    pluralName: 'habilitados';
    singularName: 'habilitado';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    comentarios: Schema.Attribute.Boolean;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    diaDelEvento: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::habilitado.habilitado'
    > &
      Schema.Attribute.Private;
    programa: Schema.Attribute.Boolean;
    publishedAt: Schema.Attribute.DateTime;
    reigstros: Schema.Attribute.Boolean;
    speakers: Schema.Attribute.Boolean;
    subirFotos: Schema.Attribute.Boolean;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProgramaFmdcProgramaFmdc
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    registroExperiencia: Schema.Attribute.String;
...
export interface ApiSpeakerSpeaker extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    organizacion: Schema.Attribute.String;
...
export interface ApiVozVoz extends Struct.SingleTypeSchema {
  collectionName: 'vozs';
  info: {
    displayName: 'voz';
    pluralName: 'vozs';
  ...
  attributes: {
    ...
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::voz.voz'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
